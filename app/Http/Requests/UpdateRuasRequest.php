...
class UpdateRuasRequest extends BaseRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // 'photo'     => 'nullable|file|mimes:jpeg,jpg,bmp,png,gif|max:5120',
            // 'file'      => 'nullable|file|mimes:pdf,docx,pptx,xlsx|max:5120',
