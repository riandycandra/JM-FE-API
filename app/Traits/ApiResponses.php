...
trait ApiResponses
{
     ...
     * @return JsonResponse
     */
    public function successResponse(mixed $data, int $statusCode = Response::HTTP_OK, $message = ''): JsonResponse
    {
        $data = [
            'status' => true,
            'message'=> $message,
    ...
    {
        return $this->successResponse($data, Response::HTTP_CREATED, $message == '' ? __('crud.success.insert') : $message);
    }
